...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->policy_to_parent_view == 1 )
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="{{ url('admin/policy_to_parent/edit/') }}" type="button" class="btn btn-primary btn-rounded">
