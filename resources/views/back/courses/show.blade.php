    ...
    <div class="row">
        <div class="col-md-4" id="image">
            <div class="panel-body">
                <a class="spotlight" href="{{ url('back/images/blogs/'.$find['image']) }}">
                    <img src="{{ url('back/images/blogs/'.$find['image']) }}" style="width:200px;height: 230px;margin:100px auto;border-radius:2px;">
                </a>
            </div>
        </div>
        ...
        {{-- <div class="col-md-8" id="content">
            <div class="col-md-6">
                <div id="id_pr">
                    ...
                    : <span style="color:#042a4a;">{{ $find->author_name['id'] }}</span>
                </div>
                <hr>
                <div id="name_pr">
                    <strong>{{ trans('app.name') }}</strong>
                    : <span style="color:#042a4a;">{{ $find->author_name['name'] }}</span>
                </div>
                <hr>
                <div id="email_pr">
                    <strong>{{ trans('app.email') }}</strong>
                    : <span style="color:#042a4a;">{{ $find->author_name['email'] }}</span>
                </div>
                <hr>
                <div id="mobile_pr">
                    <strong>{{ trans('app.phone') }}</strong>
                    : <span style="color:#042a4a;">{{ $find->author_name['user_phone'] }}</span>
                </div>
                <hr>
            ...
            <div class="col-md-6">
                <div id="department_pr">
                    ...
                    : <span style="color:#042a4a;">{{ $find->author_name['role'] }}</span>
                </div>
                <hr>
                <div id="gender_pr">
                ...
                <div id="last_login_time">
                    ...
                    : <span style="color:#042a4a;">{{ $find->author_name['last_login_time'] }}</span>
                </div>
                <hr>
                <div id="note">
