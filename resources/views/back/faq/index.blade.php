...
@section('footer')
    ...
    @include('back.faq.other_scripts')
    @include('back.faq.delete')
@endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="card">
                    @if (auth()->user()->role_relation->faq_view == 1 )
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="margin-bottom: 30px;">
                                ...
                                <span style="position: relative;top: -7px;">
                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2 bt_modal" act="{{ url('admin/faq/create') }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
