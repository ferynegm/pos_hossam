...
@section('title')
    @lang('app.edit_policy_to_teacher')
@endsection
...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->policy_to_teacher_update == 1 )
                <div class="container-fluid">
                    ...
                    <div class="row" data-select2-id="11">
                        <form action="{{ url('admin/policy_to_teacher/update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
