...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->about_acadmy_update == 1 )                
                <div class="container-fluid">
                    ...
                    <div class="row" data-select2-id="11">
                        <form action="{{ url('admin/about_acadmy/update/'.$find['id']) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            <div class="row">                                            
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="title" name="title" type="text" class="form-control" placeholder="{{ trans('app.title') }}" value="{{ old('title', $find['title']) }}">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="custom-file-container file_upload" data-upload-id="file_upload">
                                                ...
                                                <label class="custom-file-container__custom-file" >
                                                    ...
                                                    <input type="hidden" name="media_hidden" value="{{ $find['media'] }}" />
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="">
                                                ...
                                                <input type="hidden" name="media_videos_hidden" value="{{ $find['media_videos'] }}" />
                                            </div>
