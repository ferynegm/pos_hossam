        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->permissions_create == 1 )
                <div class="container-fluid">
                    ...
                    {{-- /////////////////////////////////////  Table  ///////////////////////////////////////////////////////////// --}}
                    <form action="{{ url('admin/roles_permissions/store') }}" method="POST">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                                ...
                                                <td>
                                                    ...
                                                    @if ($model == 'admins')                                                
                                                        <div class="form-check me-3 me-lg-5">
                                                            <input class="form-check-input" type="checkbox" name="{{ $model }}_change_password" {{ old(''.$model.'_change_password') ? 'checked' : '' }} id="{{ $model }}_change_password"/>
                                                    ...
                                                    @if ($model == 'blog')                                                
                                                        <div class="form-check me-3 me-lg-5">
                                                            <input class="form-check-input" type="checkbox" name="{{ $model }}_comment" {{ old(''.$model.'_comment') ? 'checked' : '' }} id="{{ $model }}_comment"/>
