                    ...
                    $(".videos_section").append(`
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control video_link" name="video_link[]" placeholder="{{ trans('app.video_link') }}" value="{{ old('video_link') }}" required>
...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->teachers_update == 1 )
                <div class="container-fluid">
                    ...
                    <div class="row" data-select2-id="11">
                        <form action="{{ url('admin/teacher/update/'.$find['group_id']) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            <div class="row">                                            
                                                <div class="col-md-3">
                                                    ...
                                                    <input id="name" name="name" type="text" class="form-control" placeholder="{{ trans('app.name') }}" value="{{ old('name', $find['name']) }}">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input id="job" name="job" type="text" class="form-control" placeholder="{{ trans('app.job') }}" value="{{ old('job', $find['job']) }}">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="gender"  class="form-control">
                                                        <option value="1" {{ $find['gender'] === 1 ? 'selected' : null }}>{{ trans('app.male') }}</option>
                                                        <option value="0" {{ $find['gender'] === 0 ? 'selected' : null }}>{{ trans('app.female') }}</option>
                                                    </select>
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="">
                                                ...
                                                <textarea class="form-control ckeditor" name="description" >{{ old('description', $find['description']) }}</textarea>
                                            </div>
                                        </div>
                                            
                                        <br>
                                        <div class="form-group mb-3 videos_section">
                                            @foreach ($find_all as $video)
                                                @if ($video->video_link != null)  
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label for="video_link">الفديو</label>                                               
                                                            <iframe src="{{ $video->video_link }}?controls=0"></iframe>
                                                        </div>

                                                        <div class="col-md-3">
                                                            <label for="video_link">{{ trans('app.video_link') }}</label>
                                                            <input type="text" class="form-control video_link" name="video_link[]" placeholder="{{ trans('app.video_link') }}" value="{{ $video->video_link }}" required>
                                                            @if ($errors->has('video_link'))
                                                                <span class="text-danger text-bold">{{ $errors->first('video_link') }}</span>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="video_desc">{{ trans('app.video_desc') }}</label>
                                                            <input type="text" class="form-control" name="video_desc[]" placeholder="{{ trans('app.video_desc') }}" value="{{ $video->video_desc }}">
                                                            @if ($errors->has('video_desc'))
                                                                <span class="text-danger text-bold">{{ $errors->first('video_desc') }}</span>
                                                            @endif
                                                        </div>
                                        ...
                                        <br>
                                        <div class="form-group mb-3 buttons_videos_section">
                                            <button class="btn btn-primary btn-sm add" style="width: 90%;height: 40px;">
