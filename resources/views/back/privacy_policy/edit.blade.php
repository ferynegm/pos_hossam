...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->privacy_policy_update == 1 )
                <div class="container-fluid">
                    ...
                    <div class="row" data-select2-id="11">
                        <form action="{{ url('admin/privacy_policy/update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
