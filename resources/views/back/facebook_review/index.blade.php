...
@section('footer')
    ...
    @include('back.facebook_review.other_scripts')
    @include('back.facebook_review.delete')
@endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="card">
                    @if (auth()->user()->role_relation->facebook_reviews_view == 1 )
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="margin-bottom: 30px;">
                                ...
                                <span style="position: relative;top: -7px;">
                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2 bt_modal" act="{{ url('admin/facebook_review/create') }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
                            ...
                            <div style="overflow-x: auto;">
                                @include('back.facebook_review.table')    
                            </div>
                        </div>
                    @else
