...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            @if (auth()->user()->role_relation->blog_create == 1 )
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">المدونة</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="{{ trans('app.title') }}" id="title" name="title" value="{{ old('title') }}">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="datetime-local" class="form-control" placeholder="{{ trans('app.date') }}" id="date" name="date" value="{{ old('date') }}">
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="author"  class="form-control select2">
                                                        ...
                                                        @foreach ($admins as $admin)
                                                            <option value="{{ $admin->name }}">{{ $admin->admin_name['name'] }}</option>
                                                        @endforeach
                                                    </select>
