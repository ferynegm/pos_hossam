...
@section('footer')
    ...
    @include('back.teacher_feedback.delete')
@endsection
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="card">
                    @if (auth()->user()->role_relation->teacher_feedback_view == 1 )
                        <div class="card-body">

                            <h4 class="card-title" style="margin-bottom: 30px;">
                                @lang('app.teacher_feedback')

                                <span style="position: relative;top: -7px;">
                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2 bt_modal" act="{{ url('admin/teacher_feedback/create') }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
                            ...
                            <div style="overflow-x: auto;">
                                @include('back.teacher_feedback.table')    
                            </div>
                        </div>
                    @else
