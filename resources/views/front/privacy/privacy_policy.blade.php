...
@section('content')
    ...
    <div class="rbt-breadcrumb-default ptb--100 ptb_md--50 ptb_sm--30" style="background-image: url('front/assets/images/home/3.jpg') !important;background-repeat: no-repeat;background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-center">
                        <h2 class="title color-white">سياسة الخصوصية</h2>
                        <ul class="page-list" style="margin-bottom: 20px;">
                            ...
                            <li class="rbt-breadcrumb-item active color-white">سياسة الخصوصية</li>
                        </ul>
                    </div>
                </div>
            </div>
