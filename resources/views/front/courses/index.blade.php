...
@section('content')
    ...
    <div class="rbt-page-banner-wrapper" style="background-image: url('front/assets/images/general/10.jpg') !important;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active color-white">دورات الأكاديمية</li>
                            </ul>
                            <!-- End Breadcrumb Area  -->

                            <div class=" title-wrapper">
                                <h1 class="title color-white">دورات الأكاديمية</h1>
                            </div>

                            <p class="description text-white">دورات أكاديمية اديوستديج لجميع المراحل والأعمار</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mt--60">
                    {{ $all_courses->links('vendor.pagination.custom') }}
                </div>
            </div>
