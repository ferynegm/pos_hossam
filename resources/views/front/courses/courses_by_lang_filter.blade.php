...
@section('title')
    دورات قسم ( {{ $course_by_lang_filter_name }} )
@endsection
...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">دورات قسم ( {{ $course_by_lang_filter_name }} )</li>
                            </ul>
                            <!-- End Breadcrumb Area  -->

                            <div class=" title-wrapper">
                                <h1 class="title">دورات قسم ( {{ $course_by_lang_filter_name }} )</h1>
                            </div>
    ...
    @if (count($courses_by_lang_filter) > 0)
        <div class="rbt-section-overlayping-top rbt-section-gapBottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rbt-course-grid-column">
                            @foreach ($courses_by_lang_filter as $course)
                ...
                <div class="row">
                    <div class="col-lg-12 mt--60">
                        {{ $courses_by_lang_filter->links('vendor.pagination.custom') }}
                    </div>
                </div>
