...
@section('title')
    دورات قسم ( 
        <?php
            if($course_by_stage_filter_name == 1){
                echo "المرحلة الإبتدائية";
            }elseif ($course_by_stage_filter_name == 2) {
                echo "المرحلة الإعدادية";
            }elseif ($course_by_stage_filter_name == 3) {
...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active ">دورات قسم ( 
                                        <?php
                                            if($course_by_stage_filter_name == 1){
                                                echo "المرحلة الإبتدائية";
                                            }elseif ($course_by_stage_filter_name == 2) {
    ...
    @if (count($courses_by_stage_filter) > 0)
        <div class="rbt-section-overlayping-top rbt-section-gapBottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rbt-course-grid-column">
                            @foreach ($courses_by_stage_filter as $course)
                ...
                <div class="row">
                    <div class="col-lg-12 mt--60">
                        {{ $courses_by_stage_filter->links('vendor.pagination.custom') }}
                    </div>
                </div>
