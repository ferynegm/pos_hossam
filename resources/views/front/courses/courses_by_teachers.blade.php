...
@section('title')
    دورات مدرس ( {{ $course_by_teachers_name['name'] }} )
@endsection
...
@section('content')
    ...
    {{-- style="background-image: url('front/assets/images/general/10.jpg') !important;background-repeat: no-repeat;background-size: cover;" --}}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">دورات مدرس ( {{ $course_by_teachers_name['name'] }} )</li>
                            </ul>
                            <!-- End Breadcrumb Area  -->

                            <div class=" title-wrapper">
                                <h1 class="title">دورات مدرس ( {{ $course_by_teachers_name['name'] }} )</h1>
                            </div>
    ...
    @if (count($courses_by_teachers) > 0)
        <div class="rbt-section-overlayping-top rbt-section-gapBottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rbt-course-grid-column">
                            @foreach ($courses_by_teachers as $course)
                ...
                <div class="row">
                    <div class="col-lg-12 mt--60">
                        {{ $courses_by_teachers->links('vendor.pagination.custom') }}
                    </div>
                </div>
    ...
    @else
        <div class="rbt-card">
            <h3 class="title text-center" style="padding: 70px 30px;opacity: .8;">لاتوجد دورات لهذا المدرس حاليا</h3>
        </div>
    @endif
